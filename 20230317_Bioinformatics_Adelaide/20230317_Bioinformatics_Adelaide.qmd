...
- Merge using *harmonic-mean p-value* [@Wilson2019-ln]
    + $p^* =\frac{\sum_{i=1}^Iw_i}{\sum_i^I\frac{w_i}{p_i}}$
    + $p^* =\frac{I}{\sum_i^I1/p_i}$ if no weights provided or all $W-i$ are equal
...
- Can return weighted-mean of logFC & logCPM $wt_i = 1/p_i$
...
- Normalisation uses weights to determine areas of signal which diverge between groups
...
![The Cytoplasmic-Nuclear Shift is clear](images/ar_densities.png){width="100%" fig-align="left"}
...
![Looks like replicate variability](images/er_densities.png){width="100%" fig-align="left"}
...
![Not so sure any is being brought to the nucleus](images/gata3_densities.png){width="100%" fig-align="left"}
...
![There's an outlier sample](images/h3k27ac_densities.png){width="100%" fig-align="left"}
...
![Some rotation overall](images/h3k27ac_pca.png){width="80%" fig-align="left"}
...
![Group-based methods are best](images/ar_all_upset.png){width="80%"}

### ER

![Group-based methods are best](images/er_all_upset.png){width="80%"}

### GATA3

![Group-based methods are best](images/gata3_all_upset.png){width="80%"}

### H3K27ac


![Group-based methods are best](images/h3k27ac_all_upset.png){width="80%"}
...
- There was a [**drastic**]{.underline} difference
    ...
    + Had been near-identical so far
...
![](images/gata3_dir_upset.png){width="60%" fig-align="left"}

### Range-based $H_0$

![](images/gata3-treat-upset.png){width="60%" fig-align="left"}
