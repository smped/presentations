...
- Includes 517 extra sequences (scaffolds, patches, haplotypes)
    ...
    + Some genes have transcripts defined on scaffolds + chromsomes
...
- Tools exist for modifying a reference genome
    + Unable to analyse at the transcript level $\implies$ only gene-leve
    
. . .

- Developing the software to produce a variant-modified transcriptome
    + Will enable counts ate the transcript-level

. . .

- Current approach uses 1000 Genomes Project variants
...
- A reference pan-genome is now available[^1]
