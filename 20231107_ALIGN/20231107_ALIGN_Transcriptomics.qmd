...
- Despite many mRNA representing an intermediary state, this reveals a lot of information about the cell, e.g. what it's responding to, how it's maintaining itself
...
- Projection onto Latent Space (PLS) is a *supervised* approach
    + Maximises correlations with predictor variables
...
- Uses clustering to identify cell types
...
- Interpretation is key
    + Researchers love to invent stories & patterns
