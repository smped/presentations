...
- First discovered microarrays and R in 2002
    ...
    + Very different to epidemioogy, study design etc
...
- To understand transcriptomics, we do need to revisit the basics
:::
...
- Is generally static, but a huge amount happens to it & around it
    + Statis in terms of the sequence doesn't change and the molecule is heavily protected and preserved
:::
