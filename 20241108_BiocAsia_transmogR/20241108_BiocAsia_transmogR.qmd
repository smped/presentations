...
- Study with ~1350 Aboriginal participants
...
- Source of this risk remains unknown
    + After controlling for external risk factors $\implies$ still increased risk
...
::: {.notes}
- Alex, Kim etc setup in consultationwith community
:::
...
![](assets/calvin.png){.absolute top=0 right=30 width="250"}
