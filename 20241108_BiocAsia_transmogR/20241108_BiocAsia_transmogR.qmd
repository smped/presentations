...
## Technical Assessment {visibility='hidden'}

::: {.columns}

::: {.column width="35%"}
- Looking simply at reads moving between genes
- Far more divergent than summary statistics indicate
- Lots of change in HLA transcripts
    + Will be treating as a stand-alone analysis
:::
...
![](assets/TheKids-RGB_Logo_Colour-Pattern.png){.absolute top=0 right=0 width="400"}

![](assets/ANU_Primary_Horizontal_GoldBlack.jpg){.absolute top=300 right=20 width="350"}

![](assets/bodl_logo_white_background.jpg){.absolute top=450 right=0 width="400"}
